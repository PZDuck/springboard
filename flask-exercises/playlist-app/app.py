...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:password@localhost:5432/playlist_app'
...
def show_song(song_id):
    ...
    playlists = Playlist.query.filter(Playlist.songs.any(id=song_id)).all()
