 ...
 *
 **/
userRouter.get('/:username/to', ensureLoggedIn, ensureCorrectUser, async (req, res, next) => {
    try {
 ...
 *
 **/
userRouter.get('/:username/from', ensureCorrectUser, ensureLoggedIn, async (req, res, next) => {
    try {
